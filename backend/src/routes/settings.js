...
const defaultSettings = [
  ...
  ['gateway_model_max_inflight_deepseek_v32_enabled', 'true'],
  ['gateway_model_max_inflight_deepseek_v32', '50'],
  ['gateway_endpoint_max_inflight_default', '10'],
  ['gateway_queue_max_size', '3000'],
  ['gateway_queue_wait_timeout_ms', '45000'],
  ['gateway_nvidia_deepseek_fast_enabled', 'true'],
  ['gateway_nvidia_deepseek_fast_max_tokens', '256'],
  ['gateway_nvidia_deepseek_fast_temperature', '0.2'],
  ['gateway_nvidia_deepseek_fast_top_p', '0.8'],
  ['gateway_nvidia_fast_enabled', 'true'],
  ['gateway_nvidia_fast_max_tokens', '256'],
  ['gateway_nvidia_fast_temperature', '0.2'],
  ['gateway_nvidia_fast_top_p', '0.8'],
  ['gateway_nvidia_fast_connect_timeout_ms', '8000'],
  ['gateway_nvidia_fast_idle_timeout_ms', '25000'],
  ['gateway_nvidia_fast_request_timeout_ms', '20000'],
  ['gateway_nvidia_fast_ping_interval_ms', '250'],
  ['gateway_nvidia_fast_ping_timeout_ms', '2500'],
...
router.put('/', auth, requireAdmin, async (req, res) => {
  const allowed = [
    ...
    'gateway_model_max_inflight_deepseek_v32_enabled', 'gateway_model_max_inflight_deepseek_v32',
    'gateway_endpoint_max_inflight_default',
    'gateway_queue_max_size', 'gateway_queue_wait_timeout_ms',
    'gateway_nvidia_deepseek_fast_enabled', 'gateway_nvidia_deepseek_fast_max_tokens',
    'gateway_nvidia_deepseek_fast_temperature', 'gateway_nvidia_deepseek_fast_top_p',
    'gateway_nvidia_fast_enabled', 'gateway_nvidia_fast_max_tokens',
    'gateway_nvidia_fast_temperature', 'gateway_nvidia_fast_top_p',
    'gateway_nvidia_fast_connect_timeout_ms', 'gateway_nvidia_fast_idle_timeout_ms',
    'gateway_nvidia_fast_request_timeout_ms', 'gateway_nvidia_fast_ping_interval_ms',
    'gateway_nvidia_fast_ping_timeout_ms',
